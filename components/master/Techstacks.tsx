...
function Techstacks() {
	return (
		<>
			...
			<TechItem title="NestJS">
				<SiNestjs title="" className="size-10" color={SiNestjsHex} />
			</TechItem>
			<TechItem title="PostgreSQL">
				<SiPostgresql title="" className="size-10" color={SiPostgresqlHex} />
			</TechItem>
			<TechItem title="Go">
				<SiGo title="" className="size-10" color={SiGoHex} />
			</TechItem>
			<TechItem title="Docker">
				<SiDocker title="" className="size-10" color={SiDockerHex} />
			</TechItem>
			<TechItem title="Redis">
				<SiRedis title="" className="size-10" color={SiRedisHex} />
			</TechItem>
		</>
	);
}
